...
<script>
	...
	/** @type {any|undefined} [dataset] - The dataset to work off of—defaults to $data if left unset. You can pass something custom in here in case you don't want to use the main data or it's in a strange format. */
	...
	function findItem(evt) {
		...
		// console.log(found.vx, found.vy, found.x, found.y);
